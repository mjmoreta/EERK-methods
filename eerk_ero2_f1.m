...
for ll=1:8
    ...
    for r=1:1
        ...
        % They are Dirichlet.
        vecb2(1,2)=vecb2(1,2)+hdiv*cost;
        vecb2(N-1,2)=vecb2(N-1,2)+hdiv*cost1;
    
        vecb2(1,3)=-hdiv*sint;
        vecb2(N-1,3)=-hdiv*sint1;
        ...
        vecb(1,2)=vecb(1,2)+hdiv*cost;
        vecb(N-1,2)=vecb(N-1,2)+hdiv*cost1;
            
        % Calculus of boundary conditions   
        sintk2=sin(t+k2);
        costk2=cos(t+k2);
        sint1k2=sin(1+t+k2);
        cost1k2=cos(1+t+k2);
        ...
        chAu=-cost;
        auxh=-sintk2+costk2-costk2^2;
        chg=(cost-k2*sint)^2+auxh;     
        vecb(1,3)=hdiv*(chAu+chg);
   
        chAu=-cost1;
        auxh=-sint1k2+cost1k2-cost1k2^2;
        chg=(cost1-k2*sint1)^2+auxh;
        vecb(N-1,3)=hdiv*(chAu+chg);            
            
        vecb(1,4)=hdiv*(sint);   
        vecb(N-1,4)=hdiv*(sint1);
